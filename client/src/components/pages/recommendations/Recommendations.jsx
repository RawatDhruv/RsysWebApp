            ...
            setLoadingtrue()
                ...
                try{
                    ...
                    if (recommender_type=== "userBasedCF"){
                      console.log("making pst request to 'http://127.0.0.1:5000/recommendations/usercolaborativefiltering'")
                      res = await axios.post('http://127.0.0.1:5000/recommendations/usercolaborativefiltering', data, config)

                    }else{
                      console.log("making pst request to 'http://127.0.0.1:5000/recommendations/itemcolaborativefiltering'")
                      res = await axios.post('http://127.0.0.1:5000/recommendations/itemcolaborativefiltering', data, config)
